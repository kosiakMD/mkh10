		...
		<div class="container">
			...
			<div id="navbar" class="collapse navbar-collapse pull-left">
				...
				<div class="pull-right">
					<button class="btn btn-danger disabled glyphicon glyphicon-floppy-disk" title="New Line"></button>
					<button class="btn btn-default disabled glyphicon glyphicon-arrow-left" title="New Line"></button>
					<button class="btn btn-default disabled glyphicon glyphicon-arrow-right" title="New Line"></button>
					<button class="btn btn-default glyphicon glyphicon-triangle-bottom" title="New Line"></button>
					<button class="btn btn-default glyphicon glyphicon-triangle-top" title="New Line"></button>
					<button id="add_string" class="action btn btn-success glyphicon glyphicon-plus" title="New Line" data-action="annNewLine"></button>
					<button class="action btn btn-danger glyphicon glyphicon-lock" data-action="toglleEditor" title="Lock Editor"></button>
				</div>
		</div><!-- /container -->
...
<br><br><br>
		...
		<div id="view_content" class="row row-offcanvas " ng-view="content">
				...
				<?php
					...
					<div class="row element">
						...
						<div class="row col-xs-10 col-md-3">
							<input class="col-md- col-xs-3 text-center field" value="<?=$val->l1?>" />
							<input class="col-md- col-xs-3 text-center field" value="<?=$val->n1?>" />
							<input class="col-md- col-xs-3 text-center field" value="<?=$val->l2?>" />
							<input class="col-md- col-xs-3 text-center field" value="<?=$val->n2?>" />
						</div>
						<div class="col-md-1 col-xs-2 pull-right">
							...
							<input class="col-md-7 col-xs-12 field" value="<?=$val->label?>" />
						<br>
					</div>
					<? } ?>
			</div>
			<div id="sample" class="container hidden">
				<div class="row element">
						...
						<div class="row col-xs-10 col-md-3">
						<input class="col-md- col-xs-3 text-center field" value="" />
						<input class="col-md- col-xs-3 text-center field" value="" />
						<input class="col-md- col-xs-3 text-center field" value="" />
						<input class="col-md- col-xs-3 text-center field" value="" />
					</div>
						...
						<input class="col-md-7 col-xs-12 field" value="" />
					<br>
				</div>
			</div>
	...
	<script>
		...
		$("body").on('click change switchChange.bootstrapSwitch', ".action", function(e){
			...
			$(action).each(function(key, value){
				...
				switch (value){
					...
					break;
					case "toggleLock":
						console.log("Lock/NnLock");
						el.toggleClass("disabled");
					break;
					case "toglleEditor":
						console.log("toglleEditor");
						el.toggleClass("btn-primary").toggleClass("btn-danger");
						$("#list .field").prop("disabled", function(){return !($(this).prop("disabled"))} );
					break;
					default:
		...
		function save(type){
			...
			setTimeout(function(){$("#preloader").toggle()}, 1000) ;
		}
	</script>
</body>
</html>